...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public interface TabIconProvider {
        ...
        int getSelectedPageIconResId(int position);
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == mViewPager.getCurrentItem()) {
                ...
                if (ImageView.class.isInstance(tabTitleView) && adapter instanceof TabIconProvider){
                    TabIconProvider mTabIconProvider = (TabIconProvider) adapter;
                    tabTitleView.setBackgroundResource(mTabIconProvider.getSelectedPageIconResId(i));
                }
            }
        }
    }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < mTabStrip.getChildCount(); i++) {
                ...
                View tabTitleView = childAt.findViewById(mTabViewTextViewId);
                if (position == i) {
                    if (ImageView.class.isInstance(tabTitleView) && adapter instanceof TabIconProvider){
                        TabIconProvider mTabIconProvider = (TabIconProvider) adapter;
                        tabTitleView.setBackgroundResource(mTabIconProvider.getSelectedPageIconResId(i));
